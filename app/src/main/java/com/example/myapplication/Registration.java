                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            ...
                            FirebaseDatabase.getInstance().getReference("Users")
                                    ...
                                    .setValue(user).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            ...
                                            if(task.isSuccessful()){
                                                Toast.makeText(Registration.this, "Successfully registered " + username, Toast.LENGTH_LONG).show();
                                                ...
                                                Toast.makeText(Registration.this, "Failed to register (Database)", Toast.LENGTH_LONG).show();
                                                progressBar.setVisibility(View.GONE);
                                            }
                                        }
                                    });
                            ...
                            Toast.makeText(Registration.this, "Failed to register (Authentication)", Toast.LENGTH_LONG).show();
                            progressBar.setVisibility(View.GONE);
                        }
                    }
                });
